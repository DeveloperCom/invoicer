...
function InvoiceGenerator() {
    ...
    useEffect(() => {
        let invoiceFirstRequest = () => {
            ...
            fetch('https://invoicer-backend-uhvk.onrender.com/api/user/invoice-generator/request', {
                method: 'POST',
                headers: headers,
    ...
    function handleSubmit(event) {
        ...
        let submitInvoice = () => {
            ...
            fetch('https://invoicer-backend-uhvk.onrender.com/api/user/invoice-generator', {
                method: 'POST',
                headers: headers,
